(function (global) {
  ...
  React.createElement(
    "g",
    { "data-name": "Layer 1" },
    React.createElement("path", { "class": "cls-1", d: "M15.363 3.515h-1.094V2.083a.552.552 0 0 0-.552-.552H9.993a.552.552 0 0 0-.552.552v1.432H6.776V2.083a.552.552 0 0 0-.552-.552H2.5a.552.552 0 0 0-.552.552v1.432H.671a.6.6 0 0 0-.6.6v10.374a.6.6 0 0 0 .6.6h14.691a.6.6 0 0 0 .6-.6V4.115a.6.6 0 0 0-.599-.6zm-.8 10.173H1.472V4.915H3.35V2.932h2.026v1.983h5.466V2.932h2.026v1.983h1.694z", role: "presentation" }),
