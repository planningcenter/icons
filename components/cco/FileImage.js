(function (global) {
  ...
  React.createElement(
    ...
    React.createElement("path", { className: "cls-1", d: "M4.2 12.638h7.682V6.689H4.2zm6.932-5.2v2.948l-.78-.91-1.16 1.359L6.89 8.149l-1.936 2.259V7.439zM4.954 11.56L6.89 9.3l2.217 2.587H4.954zm4.322.328l1.08-1.26.78.911v.349z", role: "presentation" }),
    React.createElement("circle", { className: "cls-1", cx: "9.2", cy: "8.707", r: ".433" })
  )
);;
  }
