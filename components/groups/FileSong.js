(function (global) {
  ...
  React.createElement(
    ...
    React.createElement(
      ...
      React.createElement("path", { className: "cls-1", d: "M10.571 7.254a.646.646 0 0 0-.645-.646l-2.954.723a.644.644 0 0 0-.488.625v2.654a1.284 1.284 0 0 0-.451-.091 1.3 1.3 0 1 0 1.3 1.3 1.223 1.223 0 0 0-.033-.162c.01.01.023.024.033.032V8.345l2.388-.607V9.8a1.285 1.285 0 0 0-.459-.093 1.3 1.3 0 1 0 1.3 1.3h.008zM6.033 12.37a.551.551 0 1 1 .551-.551.551.551 0 0 1-.551.551zm3.229-.812a.551.551 0 1 1 .551-.551.551.551 0 0 1-.55.551z", role: "presentation" })
    )
  )
);;
  }
