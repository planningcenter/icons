(function (global) {
  ...
  React.createElement(
    ...
    React.createElement(
      "g",
      { "data-name": "Layer 5" },
      React.createElement("path", { className: "cls-1", d: "M7.15 7.21v.52a.29.29 0 0 1-.3.27.3.3 0 0 1-.29-.26h-.35v1.52a.3.3 0 0 1 .26.29.29.29 0 0 1-.29.29h-.53a.29.29 0 0 1-.29-.29.3.3 0 0 1 .26-.29v-1.5h-.44A.28.28 0 0 1 4.9 8a.29.29 0 0 1-.29-.29v-.5a.29.29 0 0 1 .29-.29.3.3 0 0 1 .29.26h1.39a.29.29 0 0 1 .57 0zm3.67 1.14H8.25a.42.42 0 0 1 0-.85h2.57a.42.42 0 0 1 0 .85zm0 1.48H8.25a.42.42 0 0 1 0-.85h2.57a.42.42 0 0 1 0 .85zm0 1.48H5a.42.42 0 0 1 0-.85h5.84a.42.42 0 0 1 0 .85zm0 1.47H5a.42.42 0 1 1 0-.85h5.84a.42.42 0 0 1 0 .85z", role: "presentation" }),
