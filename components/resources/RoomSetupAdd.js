(function (global) {
  ...
  var RoomSetupAdd = function RoomSetupAdd() {
    return React.createElement(
  "svg",
  { "data-name": "Layer 1", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 16 16", "aria-labelledby": "title", role: "img", className: "symbol symbol-room-setup-add" },
  React.createElement(
    "title",
    { id: "title" },
    "room-setup-add icon"
  ...
  React.createElement("path", { className: "cls-1", d: "M13.507 12.068a.71.71 0 0 1-.745.719h-8.19a.709.709 0 0 1-.745-.719c0-.434.333-.386.745-.386h8.191c.411 0 .745-.048.745.386z", role: "presentation" }),
  React.createElement("path", { className: "cls-2", d: "M10.726 0h1.064v5.319h-1.064z", role: "presentation" }),
  React.createElement("path", { className: "cls-2", d: "M13.917 2.128v1.064H8.6V2.128z", role: "presentation" })
);;
  }

  if (typeof module === "object" && module.exports) {
    module.exports = RoomSetupAdd;
  } else {
    global.ResourcesIcon = global.ResourcesIcon || {};
    global.ResourcesIcon.RoomSetupAdd = RoomSetupAdd;
  }
})(this)
