(function (global) {
  ...
  var GeoPinOutlineIcon = function GeoPinOutlineIcon() {
  ...
  React.createElement("path", { "class": "cls-1", d: "M8 .028a5.849 5.849 0 0 0-5.695 5.979 6.066 6.066 0 0 0 1.109 3.542l3.8 5.979a.924.924 0 0 0 1.579 0l3.766-5.934a6.134 6.134 0 0 0 1.139-3.588A5.849 5.849 0 0 0 8 .028zm3.007 8.416L8 13.18 4.962 8.4A4.076 4.076 0 0 1 4.2 6.007 3.9 3.9 0 0 1 8 2.021a3.9 3.9 0 0 1 3.8 3.986 4.146 4.146 0 0 1-.793 2.437zM7.326 5.3a1.047 1.047 0 0 0 0 1.415.93.93 0 0 0 1.348 0 1.047 1.047 0 0 0 0-1.415.959.959 0 0 0-1.348 0z", "data-name": "Layer 1", role: "presentation" })
);
  }

  if (typeof module === "object" && module.exports) {
    module.exports = GeoPinOutlineIcon
  } else {
    global.GeoPinOutlineIcon = GeoPinOutlineIcon
  }
})(this)
