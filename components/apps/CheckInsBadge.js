(function (global) {
  ...
  var CheckInsBadge = function CheckInsBadge() {
    return React.createElement(
  "svg",
  { "data-name": "Layer 1", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 140 32", "aria-labelledby": "title", role: "img", className: "symbol symbol-check-ins-badge" },
  React.createElement(
    "title",
    { id: "title" },
    "check-ins-badge icon"
  ),
