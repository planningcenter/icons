(function (global) {
  ...
  "svg",
  { "data-name": "Layer 1", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 32 32", "aria-labelledby": "title-registrations-app", role: "img", className: "symbol symbol-registrations-app" },
  React.createElement(
    "title",
    { id: "title-registrations-app" },
    "registrations-app icon"
  ),
  React.createElement("path", { "fill-rule": "evenodd", d: "M20.52 13.131l-2.677-2.425-1.782 1.945 2.658 2.459 1.801-1.979zm-5.013.125l-5.177 5.651a2.015 2.015 0 0 0-.4.86l-.36 2.665 2.621-.577a2 2 0 0 0 .819-.473l5.159-5.666zm-1.009 8.916h7.661v-1.513h-6.284l-1.377 1.513z", role: "presentation" }),
