(function (global) {
  ...
  React.createElement("rect", { className: "cls-2", x: "9", y: "10", width: "14", height: "3", rx: ".464", ry: ".464" }),
  React.createElement("rect", { className: "cls-2", x: "9", y: "15", width: "14", height: "3", rx: ".464", ry: ".464" }),
  React.createElement("rect", { className: "cls-2", x: "9", y: "20", width: "14", height: "3", rx: ".464", ry: ".464" })
);;
  }
