(function (global) {
  ...
  React.createElement("path", { className: "cls-1", d: "M14.7 1.25C13.241-.207 12.148.012 12.148.012l-5.1 5.1-5.829 5.828L.2 15.748l4.808-1.02L10.837 8.9l5.1-5.1s.218-1.093-1.237-2.55zm-9.976 12.9l-1.641.35a3.745 3.745 0 0 0-.7-.941 3.763 3.763 0 0 0-.94-.7l.357-1.633.474-.474a3.067 3.067 0 0 1 1.9 1.025 3.07 3.07 0 0 1 1.025 1.9z", "data-name": "Layer 1", role: "presentation" })
);;
  }
