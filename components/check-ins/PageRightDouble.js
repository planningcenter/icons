(function (global) {
  ...
  React.createElement(
    "g",
    { "data-name": "Layer 1" },
    React.createElement("path", { className: "cls-1", d: "M9.637 1.637L6.934 4.339 10.596 8l-3.662 3.661 2.703 2.702L16 8 9.637 1.637z", role: "presentation" }),
    React.createElement("path", { className: "cls-1", d: "M2.702 1.637L0 4.339 3.661 8 0 11.661l2.702 2.702L9.066 8 2.702 1.637z", role: "presentation" })
  )
);;
  }
