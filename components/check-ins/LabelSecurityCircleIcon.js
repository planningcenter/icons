(function (global) {
  ...
  var LabelSecurityCircleIcon = function LabelSecurityCircleIcon() {
    return React.createElement(
  "svg",
  { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 16 16", "aria-labelledby": "title", role: "img", className: "symbol symbol-label-security-circle" },
  React.createElement(
    "title",
    { id: "title" },
