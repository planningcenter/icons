(function (global) {
  ...
  var MusicStand = function MusicStand() {
  ...
  if (typeof module === "object" && module.exports) {
    module.exports = MusicStand;
  } else {
    global.ServicesIcon = global.ServicesIcon || {};
    global.ServicesIcon.MusicStand = MusicStand;
  }
})(this)
