...
import brand from "../../sprites/brand.svg"
...
export default function Brand() {
  return (
    <>
      ...
      <Symbol symbol={`${brand}#chrome`} />
      <Symbol symbol={`${brand}#edge`} />
      <Symbol symbol={`${brand}#facebook-outline`} />
      <Symbol symbol={`${brand}#facebook`} />
      <Symbol symbol={`${brand}#firefox`} />
      <Symbol symbol={`${brand}#ie`} />
      <Symbol symbol={`${brand}#instagram`} />
